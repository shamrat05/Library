...
class SessionManager {
    ...
    loadSessions() {
        ...
        this.renderSessions();
        // Reinitialize event listeners when sessions page loads
    ...
    async startSession(sessionId) {
        try {
            ...
            console.log('Starting session:', updatedSession);

            // Navigate to video room first
            app.navigateToPage('videoRoom');

            // Wait a bit for the page to load, then initialize video session
            setTimeout(async () => {
